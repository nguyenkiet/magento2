...
class Report extends DPaypalBaseAction
{
    ...
    public function __construct(
        ...
        parent::__construct($context, $resourceConnection, $localeResolver, $scopeConfig, $transaction, $transportBuilder,
            $order, $dpaypal, $checkoutSession, $transactionRepository, $transactionBuilder, $invoiceSender);
    }
