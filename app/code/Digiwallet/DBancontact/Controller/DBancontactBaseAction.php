<?php
namespace Digiwallet\DBancontact\Controller;
 ...
 * @method POST
 */
class DBancontactBaseAction extends \Magento\Framework\App\Action\Action
{
    /**
    ...
    public function checkDigiwalletResult()
    {
        ...
        $testMode = false;//(bool) $this->scopeConfig->getValue('payment/dbancontact/testmode', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        $digiCore = new DigiwalletCore(
            $this->dbancontact->getMethodType(),
            $this->scopeConfig->getValue('payment/dbancontact/rtlo', \Magento\Store\Model\ScopeInterface::SCOPE_STORE),
            $language,
            $testMode
        );
        ...
        if ($paymentStatus) {
            $sql = "UPDATE ".$tableName."
                ...
                AND method='" . $this->dbancontact->getMethodType() . "'
                AND `digi_txid` = '" . $txId . "'";
            $db->query($sql);
            ...
            $transport = $this->transportBuilder
                ->setTemplateIdentifier(
                    $this->scopeConfig->getValue('payment/dbancontact/email_template/failure', \Magento\Store\Model\ScopeInterface::SCOPE_STORE),
                    $storeScope
                )
                ->setTemplateOptions([
