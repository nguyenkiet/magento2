 ...
 * @method POST
 */
class Report extends DAfterpayBaseAction
{
    ...
    public function execute()
    {
        ...
        if (! parent::checkDigiwalletResult($txId, $orderId)) {
            ...
            $transport = $this->transportBuilder->setTemplateIdentifier($this->scopeConfig->getValue('payment/dafterpay/email_template/failure', \Magento\Store\Model\ScopeInterface::SCOPE_STORE), $storeScope)
                ->setTemplateOptions([
