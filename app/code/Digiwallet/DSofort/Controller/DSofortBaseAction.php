<?php
namespace Digiwallet\DSofort\Controller;
 ...
 * @method POST
 */
class DSofortBaseAction extends \Magento\Framework\App\Action\Action
{
    /**
    ...
    public function checkDigiwalletResult()
    {
        ...
        $testMode = false;//(bool) $this->scopeConfig->getValue('payment/dsofort/testmode', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        $digiCore = new DigiwalletCore(
            $this->dsofort->getMethodType(),
            $this->scopeConfig->getValue('payment/dsofort/rtlo', \Magento\Store\Model\ScopeInterface::SCOPE_STORE),
            $language,
            $testMode
        );
        ...
        if ($paymentStatus) {
            $sql = "UPDATE ".$tableName." 
                ...
                AND method='" . $this->dsofort->getMethodType() . "'
                AND `digi_txid` = '" . $txId . "'";
            $db->query($sql);
            ...
            $transport = $this->transportBuilder
                ->setTemplateIdentifier(
                    $this->scopeConfig->getValue('payment/dsofort/email_template/failure', \Magento\Store\Model\ScopeInterface::SCOPE_STORE),
                    $storeScope
                )
                ->setTemplateOptions([
